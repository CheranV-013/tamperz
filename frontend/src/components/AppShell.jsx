  ...
  return (
    <div className="min-h-screen bg-transparent px-6 pb-14 grid-dots">
      <div className="app-shell w-full">
        <Navbar />
        <div className="mt-4 grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8 items-start w-full">
          <aside className="panel p-4 h-fit sticky top-6 w-full lg:self-start">
          ...
          <main key={location.pathname} className="page-enter min-w-0 w-full">
            {children}
          </main>
        </div>
      </div>
