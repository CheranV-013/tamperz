  ...
  return (
    <div className="min-h-screen bg-transparent px-6 pb-14 grid-dots">
      <div className="app-shell">
        <Navbar />
        <div className="mt-4 grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8 items-start">
          <aside className="panel p-4 h-fit sticky top-6 w-full">
          ...
          <main key={location.pathname} className="page-enter min-w-0">
            {children}
          </main>
        </div>
      </div>
